    ...
    <body>
        ...
        <div class="container py-5">
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4 mb-3">
                    <a href="${pageContext.request.contextPath}/views/service/hairCurlingService.jsp" class="service-card">
                ...
                <div class="col-md-4 mb-3">
                    <a href="${pageContext.request.contextPath}/views/service/hairDyeingService.jsp" class="service-card">
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    <a href="${pageContext.request.contextPath}/views/service/earWaxRemovalService.jsp" class="service-card">
