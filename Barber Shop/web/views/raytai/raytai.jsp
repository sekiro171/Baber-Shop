...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarNav">
                ...
                <div class="d-flex gap-2">
                    <a class="btn btn-outline-primary fw-medium" href="${pageContext.request.contextPath}/views/auth/login.jsp">Đăng nhập</a>
                    <a class="btn btn-primary fw-medium" href="${pageContext.request.contextPath}/views/auth/register.jsp">Đăng ký</a>
                </div>
            </div>
        </div>
    </nav>
    ...
    <section class="booking-cta text-center py-5">
        <div class="container">
            ...
            <a href="#" class="btn btn-primary btn-lg fw-medium">Đặt lịch ngay</a>
        </div>
    </section>
