...
<html>
    <head>
        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/CSS/spa1.css">
    ...
    <body>
        ...
        <div class="container text-center py-4">
            <h2 class="combo-title">COMBO GỘI THƯ GIÃN CỔ VAI GÁY</h2>

            <!-- Banner image below title -->
            <div class="mb-4">
                <img src="${pageContext.request.contextPath}/image/spa1/banner.png" class="img-fluid rounded shadow" alt="Combo Banner">
            </div>
            ...
            <div class="text-start mt-5">
                ...
                <div class="process-grid">
                    <div class="process-item">
                        <img src="${pageContext.request.contextPath}/image/spa1/1.png" class="img-fluid process-img shadow-sm mb-2" alt="Tác động sâu vùng cơ mặt">
                        <p class="mb-0 fw-bold" style="color: #201E15;">Tác động sâu vùng cơ mặt</p>
                    </div>
                    <div class="process-item">
                        <img src="${pageContext.request.contextPath}/image/spa1/2.png" class="img-fluid process-img shadow-sm mb-2" alt="Thư giãn vùng đầu">
                        <p class="mb-0 fw-bold" style="color: #201E15;">Thư giãn vùng đầu</p>
                    </div>
                    <div class="process-item">
                        <img src="${pageContext.request.contextPath}/image/spa1/3.png" class="img-fluid process-img shadow-sm mb-2" alt="Rửa mặt & chăm sóc da mặt">
                        <p class="mb-0 fw-bold" style="color: #201E15;">Rửa mặt & chăm sóc da mặt</p>
                    </div>
                    <div class="process-item">
                        <img src="${pageContext.request.contextPath}/image/spa1/4.png" class="img-fluid process-img shadow-sm mb-2" alt="Phun sương hoa hồng">
                        <p class="mb-0 fw-bold" style="color: #201E15;">Hút mụn & Phun nước hoa hồng</p>
                    </div>
                    <div class="process-item">
                        <img src="${pageContext.request.contextPath}/image/spa1/5.png" class="img-fluid process-img shadow-sm mb-2" alt="Xối mắt thác đổ">
                        <p class="mb-0 fw-bold" style="color: #201E15;">Tẩy da chết & đắp mặt nạ</p>
                    </div>
                    <div class="process-item">
                        <img src="${pageContext.request.contextPath}/image/spa1/6.png" class="img-fluid process-img shadow-sm mb-2" alt="Thư giãn cổ vai gáy">
                        <p class="mb-0 fw-bold" style="color: #201E15;">Thư giãn cổ vai gáy</p>
                    </div>
                    <div class="process-item">
                        <img src="${pageContext.request.contextPath}/image/spa1/7.png" class="img-fluid process-img shadow-sm mb-2" alt="Thư giãn cổ">
                        <p class="mb-0 fw-bold" style="color: #201E15;">Rửa tai & thư giãn tai/p>
                    </div>
                    <div class="process-item">
                        <img src="${pageContext.request.contextPath}/image/spa1/8.png" class="img-fluid process-img shadow-sm mb-2" alt="Xối nước thác đổ">
                        <p class="mb-0 fw-bold" style="color: #201E15;">Xối nước thác đổ</p>
                    </div>
                    <div class="process-item">
                        <img src="${pageContext.request.contextPath}/image/spa1/9.png" class="img-fluid process-img shadow-sm mb-2" alt="Cắt tóc">
                        <p class="mb-0 fw-bold" style="color: #201E15;">Cắt tóc</p>
                    </div>
                    <div class="process-item">
                        <img src="${pageContext.request.contextPath}/image/spa1/10.png" class="img-fluid process-img shadow-sm mb-2" alt="Sấy tóc">
